...
public class EsaUserEnable extends Utilies{
	...
	public void  createEsaUser(String data[]) throws Exception {
		try {
			...
			WebElement enable=driver.findElement(By.xpath("//div[@class='mat-slide-toggle-thumb'][1]"));
			enable.click();
			test.info("Enabled a esa user..");
