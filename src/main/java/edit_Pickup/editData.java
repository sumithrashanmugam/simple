...
public class editData {
	...
	public static ArrayList<String> List () throws Exception{
		...
		for (int i = 1; i <=lastRowNum; i++) {
			...
			for (int j = 0; j <lastCellNum; j++) {
	            ...
	            if(!FirstRow.equalsIgnoreCase("url") &&!FirstRow.equalsIgnoreCase("email") && !FirstRow.equalsIgnoreCase("password") )
